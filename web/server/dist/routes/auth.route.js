...
class AuthRoute {
    ...
    initializeRoutes() {
        ...
        this.router.get('/get-all-users', auth_middleware_1.default, admin_middleware_1.default, auth_controller_1.default.getAllUsers);
        this.router.delete('/delete/:id', auth_middleware_1.default, auth_controller_1.default.delete);
    }
}
